        ...
        <div className="flex items-start gap-2 md:gap-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3">
              <span className={`text-xs px-2.5 py-0.5 rounded-full bg-secondary capitalize ${getDifficultyColor(job.difficulty)}`}>
                {t(`filter.${job.difficulty}`)}
              </span>
              <span className="text-xs px-2.5 py-0.5 rounded-full bg-primary/10 text-primary font-medium whitespace-nowrap">
                {salaryDisplay}
              </span>
            </div>
          </div>
